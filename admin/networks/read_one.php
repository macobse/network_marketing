...
<head>
    ...
    <title><?php echo "User Network" ?></title>
  ...
  <!-- MetisMenu CSS -->
    ...
    <link href="../../views/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="../../libs/css/hierarchy/css/hierarchy-view.css">
    <link rel="stylesheet" href="../../libs/css/hierarchy/css/main.css">
</head>
<body>
 <div id="wrapper">
   <!-- Navigation bar -->
   <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <section class="basic-style">
      ...
      $userID = $currentUser->child_id;
      $uProfile = $user->getUserInfo($userID);
      $userName = $uProfile->fname;

      ?>

        <h1> <?php echo $userName.'\'s'. ' Network view'; ?></h1>
            ...
            <div class="hv-wrapper">
                ...
                <div class="hv-item">
                    ...
                    <div class="hv-item-parent">
                        <p class="simple-card"> <?php echo $userName; ?></p>
                    </div>
